...
$('document').ready(function(){
	...
	$('#wish_message').click(function(){
		...
		$('#b33').animate({top:500, left: vw-150},500);
		$('#b44').animate({top:500, left: vw-50},500);
		$('#b55').animate({top:500, left: vw+50},500);
		$('#b66').animate({top:500, left: vw+150},500);
